...
void til::offset_checker::do_nil_node(cdk::nil_node *const node,
                                             int lvl) {
  // EMPTY
}
void til::offset_checker::do_data_node(cdk::data_node *const node,
                                              int lvl) {
  // EMPTY
}
void til::offset_checker::do_sequence_node(
...
void til::offset_checker::do_not_node(cdk::not_node *const node,
                                             int lvl) {
  // EMPTY
}
...
void til::offset_checker::do_add_node(cdk::add_node *const node,
                                             int lvl) {
  // EMPTY
}
void til::offset_checker::do_sub_node(cdk::sub_node *const node,
                                             int lvl) {
  // EMPTY
}
void til::offset_checker::do_mul_node(cdk::mul_node *const node,
                                             int lvl) {
  // EMPTY
}
void til::offset_checker::do_div_node(cdk::div_node *const node,
                                             int lvl) {
  // EMPTY
}
void til::offset_checker::do_mod_node(cdk::mod_node *const node,
                                             int lvl) {
  // EMPTY
}
...
void til::offset_checker::do_and_node(cdk::and_node *const node,
                                             int lvl) {
  // EMPTY
}
...
void til::offset_checker::do_variable_node(
    cdk::variable_node *const node, int lvl) {
  // EMPTY
}
void til::offset_checker::do_unary_minus_node(
    cdk::unary_minus_node *const node, int lvl) {
  // EMPTY
}
void til::offset_checker::do_unary_plus_node(
...
void til::offset_checker::do_assignment_node(
    cdk::assignment_node *const node, int lvl) {
  // EMPTY
}
void til::offset_checker::do_block_node(til::block_node *const node,
                                               int lvl) {
  _symtab.push();
...
void til::offset_checker::do_index_node(til::index_node *const node,
                                               int lvl) {
  // EMPTY
}
void til::offset_checker::do_address_of_node(
    til::address_of_node *const node, int lvl) {
  // EMPTY
}
void til::offset_checker::do_evaluation_node(
    til::evaluation_node *const node, int lvl) {
  // EMPTY
}
void til::offset_checker::do_print_node(til::print_node *const node,
                                               int lvl) {
  // EMPTY
}
void til::offset_checker::do_read_node(til::read_node *const node,
                                              int lvl) {
  // EMPTY
}
void til::offset_checker::do_function_node(
    til::function_node *const node, int lvl) {
  // EMPTY
}
void til::offset_checker::do_call_node(til::call_node *const node,
                                              int lvl) {
  // EMPTY
}
...
void til::offset_checker::do_loop_node(til::loop_node *const node,
                                              int lvl) {
  node->block()->accept(this, lvl);
}
void til::offset_checker::do_stop_node(til::stop_node *const node,
                                              int lvl) {
  // EMPTY
}
void til::offset_checker::do_next_node(til::next_node *const node,
                                              int lvl) {
  // EMPTY
}
...
void til::offset_checker::do_alloc_node(til::alloc_node *const node,
                                               int lvl) {
  // EMPTY
}
